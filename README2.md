...
The `Data/` directory contains all datasets and predefined train/test splits. A more detailed description of the datasets and their licensing is provided in `Data/README.md` (if present).

You may need to download or prepare datasets separately; follow the instructions in the data-specific README or in the corresponding notebooks under `Notebooks/`.

## Models and experiments

Model families and their entry points are organized under `Models/`:
...
- `dataset_split.ipynb` — create or verify train/test splits.
...
Refer to the individual notebooks and scripts for experiment-specific details and command-line arguments.